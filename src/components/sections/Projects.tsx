...
const projects: Project[] = [
  ...
  },
  {
    ...
    description: 'A robust, high-concurrency inventory management backend for enterprise stock auditing.',
    problem: 'Businesses need reliable, real-time inventory tracking with data integrity guarantees.',
    solution: 'Architected optimized database schemas enforcing ACID properties for reliable, real-time stock auditing.',
    impact: 'Ensures seamless data visualization and reliable multi-user concurrent access.',
    tech: ['Java', 'PostgreSQL', 'JDBC', 'ACID'],
  ...
  },
  {
    ...
    subtitle: 'Financial Auditing Tool',
    type: 'Personal Project',
    description: 'A full-stack financial auditing tool with dynamic data visualization.',
    problem: 'Individuals need a clean way to track and visualize personal financial transactions.',
    solution: 'Built with PostgreSQL for transaction history and Chart.js for dynamic data visualization with normalized schemas.',
    impact: 'Enables multi-user financial record-keeping with clear visual insights.',
    tech: ['PostgreSQL', 'Chart.js', 'Node.js', 'REST API'],
